			...
			<div class="col-sm-8">
				<form method="POST" role="form" class="form-horizontal" id="fsub">
					...
					<div class="form-group" id="nodgp">
									...
									<div class="col-sm-9">
									<select name ="sid" class="form-control "id="nod" >
										<?php 
											$sql = "SELECT STAFF_ID,STAFF_NAME FROM staff";
											$result = $conn->query($sql);
											if ($result->num_rows > 0) {
												while($row = $result->fetch_assoc()) {
													echo "<option id=".$row['STAFF_ID'].">".$row['STAFF_ID']."--".$row['STAFF_NAME']."</option>"; 
												}
											} else {
					...
					<div class="form-group" id="nodgp">
							...
							<div class="col-sm-4">
								<input type='button' class='btn btn-success col-sm-12' value='Submit' id='submitButton'>
							</div>
							<div class="col-sm-1">
							</div>
							<div class="col-sm-4">
