            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-8">
							<form method="POST" action='staff_paper1.php' role="form" class="form-horizontal" id="fsub">
								<div class="form-group">
									<label class="control-label col-sm-3" for="lt">Class ID : </label>
									<div class="col-sm-9">
										<select class="form-control" id="lt" name='classID' >
							...
							<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control" id="lt" name='dayorder'>
											<option value="none" selected>---</option>
								...
								<div class="form-group" id="nodgp">
									<label class="control-label col-sm-3" for="nod" name='hour'>Hour Allocaion : </label>
									<div class="col-sm-9" >
										<table class="table table-bordered">
											...
											for($i=0;$i<8;$i++)
											{
												echo "<tr>";
												echo "<td> ". ($i+1) ."</td>";
												echo "<td><input list ='paperName' type='text' class='form-control' name='paperID".$i."'>";
												echo "<datalist id='paperName'>";
												echo "<option value ='' selected></option>";
												$sql = "select PAPER_NAME,PAPER_CODE from PAPER";
												$rs = mysqli_query($conn,$sql);
												while($row = mysqli_fetch_assoc($rs))
												{
												...
												<td><input list ='staffName' type='text' class='form-control' name='staffID".$i."'>";
												echo "<datalist id='staffName'>";
