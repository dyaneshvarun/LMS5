            ...
            <div class="row">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">L<!--?php echo $leave_count;?--></div>
                                    <div>Leaves</div>
                                </div>
                            </div>
                        </div>
                        <a href="today_leave.php">
                            <div class="panel-footer">
                                <span class="pull-left">Today's Leave</span>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div>Altered List</div>
                                </div>
                            </div>
                        </div>
                        <a href="today_alter.php">
                            <div class="panel-footer">
                                <span class="pull-left">Today's Altered List</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <!--div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">Today's Leave Application</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $ar_count; ?></div>
                                    <div>Awaiting Response</div>
                                </div>
                            </div>
                        </div>
                        <a href="awaiting_response1.php">
                            <div class="panel-footer">
                                <span class="pull-left">Leave Awaiting Response</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $declined; ?></div>
                                    <div>Declined Response</div>
                                </div>
                            </div>
                        </div>
                        <a href="declined_response.php">
                            <div class="panel-footer">
                                <span class="pull-left">Declined Leave List</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
            ...
            <div class="col-lg-3 col-md-6">
				...
				<div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        ...
                        <a href="cancelRequest.php">
                            <div class="panel-footer">
                                <span class="pull-left">Cancel Request</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
