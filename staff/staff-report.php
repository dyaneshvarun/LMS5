...
<?php require_once("header.php");?>
    ...
    <div id="page-wrapper">
			...
			<div class="col-sm-8">
				<form method="POST" role="form" class="form-horizontal" action='staffwiseperiodicRep1.php' id="fsub">
					...
					<div class="form-group" id="nodgp">
									...
									<div class="col-sm-9">
									<select name ="sid" class="form-control "id="staffid" disabled >
										<?php 
											$sql = "SELECT STAFF_ID,STAFF_NAME FROM staff WHERE STAFF_ID=$sta_id ";
		...
		<div class="container-fluid">
			<b>* Only Accepted Leaves will be shown here. For the entire leave list click the Leave List Icon on the dashboard.</b>
