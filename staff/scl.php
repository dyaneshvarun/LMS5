...
<?php require_once("header.php");?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Special Casual Leave Application</h1><br>
                        <div class="col-sm-8">
							<form method="POST" role="form" class="form-horizontal" id="fsub">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<input type="input" class="form-control" id="tot" value="<?php echo $s_scl; ?>" disabled>
									</div>
									<label class="control-label col-sm-2" for="name">Balance : </label>
									<div class="col-sm-2">
										<input type="input" class="form-control" id="bal" value="<?php echo ($tscl['NOD'] - $s_scl); ?>" disabled>
									</div>
								</div>
