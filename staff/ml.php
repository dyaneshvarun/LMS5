...
<?php require_once("header.php");?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Medical Leave Application</h1><br>
                        <div class="col-sm-9">
							<form method="POST" role="form" class="form-horizontal" id="fsub">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control" id="lt" disabled >
											...
											<option value="ml" selected >Medical Leave</option>
											
										</select>
									</div>
								</div>
								<!-- Availed and balance not needed !
								div class="form-group">
								...
								<div class="form-group" id="nodgp">
									...
									<div class="col-sm-9">
										<input type="input" class="form-control" id="nod" disabled>
									</div>
								</div>
								<div class="form-group">
