	...
	$("#fsub").submit(function(e){
		...
		if(opterr == 0 && noderr == 0 && reserr == 0 && d1err == 0 &&staffErr==0){
			...
			$.post("qengine.php",{
				...
				if(data == 1){
					var today = new Date();
					var StaffContent = " Leave Type : <b> OD </b>(Leave Type) <br/>Number of Days :<b>"+$("#nod").val() +"day(s)</b><br/>From Date:<b> "+fdate+" </b><br/>To date:<b> "+tdate +"</b><br/>Applied date : <b>"+today+"</b>";
					$.post("../testMail.php",{
