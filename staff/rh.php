...
<?php require_once("header.php");?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Restricted Leave Application</h1><br>
                        <div class="col-sm-8">
							<form method="POST" role="form" class="form-horizontal" id="fsub">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control" id="lt" disabled>
											...
											<option value="rh"  selected >Restricted Holiday</option>
								...
								<div class="form-group">
									...
									<select name="rh" id = 'rh' class="form-control">
										<option value="none" >---</option>
										<?php 
											$sql = "SELECT DATE,FUNCTION_NAME FROM restricted_holiday";
											$result = $conn->query($sql);
											if ($result->num_rows > 0) {
												while($row = $result->fetch_assoc()) {
													echo "<option  value ='".$row['DATE']."'>".$row['DATE']."    --     ".$row['FUNCTION_NAME']."</option>"; 
												}
											} else {
													echo "Error. No restricted holiday.";
											}
										?>
										</select>
										</div>
								...
								<div class="form-group" id="nodgp">
									...
									<div class="col-sm-9">
										<input type="input" class="form-control" value='1' id="nod" disabled>
									</div>
								</div>
								<div class="form-group">
