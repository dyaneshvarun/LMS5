<?php
	...
	if($row['STAFF_ID'] != $sta_id){
		echo "You're trying to view the Leave of Other Staff";
		exit();
	}
                ...
                <div class="row">
					<div class="col-lg-offset-2 col-lg-8">
						...
						<table class="table">
							...
							<tr>
								<td>No of Days : </td>
								<td><?php echo $row['NOD']; $numberOfDays=$row['NOD']; ?></td>
							</tr>
							<tr>
								<td>Leave Type : </td>
						...
						<?php
							...
							else if($row['LEAVE_TYPE']=="ML" && $numberOfDays>3) $x = "tablePdfML.php";
							else if($row['LEAVE_TYPE']=="EL" && $numberOfDays<=3) $x = "tablePdfCL.php";
