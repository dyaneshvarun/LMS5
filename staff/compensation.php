...
<?php require_once("header.php");?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Compensation Leave Application</h1><br>
                        <div class="col-sm-9">
							<form method="POST" role="form" class="form-horizontal" id="fsub">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<select class="form-control" id="lt" disabled >
											...
											<option value="cpl" selected >Compensation Leave (CPL)</option>
								...
								<div class="form-group">
									...
									<label class="control-label col-sm-2" for="name">CPL Credits </label>
									<div class="col-sm-2">
										<input type="input" class="form-control" id="cpl" value="<?php echo $credits['CPL']?>" disabled>
									</div>
								</div>
								<div class="form-group" id="nodgp">
									<label class="control-label col-sm-3" for="nod">No of days : </label>
									<div class="col-sm-9">
										<input type="input" class="form-control" id="nod" >
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-3" for="date1">From Date : </label>
									<div class="col-sm-9">
										<input type="input" class="form-control" id="date1" disabled>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-3" for="date2">To Date : </label>
									<div class="col-sm-9">
										<input type="input" class="form-control" id="date2" disabled>
									</div>
								</div>
								<div class ="form-group">
									<label class="control-label col-sm-3" for="date1">Compensated Dates : </label>
									<div class="col-sm-9">
										<input type="input" class="form-control" id="compDateTab" disabled>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-3" for="vacation">Vacation : </label>
									<div class="col-sm-9">
										<input type="checkbox" class="checkbox col-lg-1" id="vacation" disabled>
									</div>
								</div>
